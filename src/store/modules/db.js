...
export default {
  ...
  actions: {
     ...
     */
    set(context, { dbName = "database", path = "", value = "" }) {
     ...
     */
    get(context, { dbName = "database", path = "", defaultValue = "" }) {
     ...
     * @param {Object} context
     */
    database(context, { dbName = "database" }) {
      return getDatabase({
        dbName,
        defaultValue: {},
      });
     ...
     */
    databaseClear(context, { dbName = "database" }) {
      return getDatabase({
        dbName,
        validator: () => false,
        defaultValue: {},
